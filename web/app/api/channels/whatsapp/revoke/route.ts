...
// POST /api/channels/whatsapp/revoke
//
// Owner-scoped revoke mutation for a linked WhatsApp command channel. Link
// creation happens through the WhatsApp inbound token handshake; Profile owns
// the matching revoke form and delegates here.
